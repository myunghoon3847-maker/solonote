const CACHE_NAME = "hoonnote-v4-5-5-cache";
...
const STATIC_ASSETS = [
  ...
  "./icons/icon-maskable-192.png?v=455",
  "./icons/icon-maskable-512.png?v=455",
  "./icons/icon-monochrome-512.png?v=455",
  "./icons/apple-touch-icon.png?v=455",
  "./legal/legal.css?v=455",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
