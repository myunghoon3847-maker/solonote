const CACHE_NAME = "hoonnote-v4-5-4-cache";
...
const STATIC_ASSETS = [
  ...
  "./icons/icon-maskable-192.png?v=454",
  "./icons/icon-maskable-512.png?v=454",
  "./icons/icon-monochrome-512.png?v=454",
  "./icons/apple-touch-icon.png?v=454",
  "./legal/legal.css?v=454",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
