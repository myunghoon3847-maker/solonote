const CACHE_NAME = "hoonnote-v4-5-3-cache";
...
const STATIC_ASSETS = [
  ...
  "./icons/icon-maskable-192.png?v=453",
  "./icons/icon-maskable-512.png?v=453",
  "./icons/icon-monochrome-512.png?v=453",
  "./icons/apple-touch-icon.png?v=453",
  "./legal/legal.css?v=453",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
