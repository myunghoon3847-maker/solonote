const CACHE_NAME = "hoonnote-v4-5-6-cache";
...
const STATIC_ASSETS = [
  ...
  "./icons/icon-maskable-192.png?v=456",
  "./icons/icon-maskable-512.png?v=456",
  "./icons/icon-monochrome-512.png?v=456",
  "./icons/apple-touch-icon.png?v=456",
  "./legal/legal.css?v=456",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
