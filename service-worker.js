const CACHE_NAME = "hoonnote-v4-5-2-cache";
...
const STATIC_ASSETS = [
  ...
  "./icons/icon-maskable-192.png?v=452",
  "./icons/icon-maskable-512.png?v=452",
  "./icons/icon-monochrome-512.png?v=452",
  "./icons/apple-touch-icon.png?v=452",
  "./legal/legal.css?v=452",
  "./legal/privacy.html",
  "./legal/terms.html",
  "./support/index.html",
