...
훈노트 v4.5.13.1은 v4.5.12 UI를 기준으로 로그인, 메모, 카테고리, 할 일, 휴지통, 백업, 계정 관리와 자동 초안을 연속 검수한 핵심 기능 회귀 안정화 버전입니다.
...
```text
https://myunghoon3847-maker.github.io/solonote/?v=464
```

메뉴 하단 버전 표시는 `v4.5.13.1`입니다.
