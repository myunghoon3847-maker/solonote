...
업무노트 v4.3.2.1은 회원가입이 완료된 v4.3.1.1을 기준으로 **안전한 계정 및 사용자 데이터 삭제 기능**을 추가한 출시 준비 버전입니다. 기존 메모·할 일·동기화·백업·PWA 기능은 유지합니다.
...
```text
https://myunghoon3847-maker.github.io/solonote/?v=4321
```

실제 계정 삭제는 중요한 데이터가 없는 테스트 계정으로 먼저 확인하세요.


## v4.3.2.1 UI 및 카테고리 정리
