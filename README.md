...
업무노트 v4.3.2.6은 v4.3.2.2의 휴지통 전용 화면을 유지하면서 **계정 삭제 과정의 데이터 손실 방지와 서버 검증을 강화한 계정 삭제 완성 후보판**입니다.
...
- v4.3.2.6 변경 기록: `CHANGES_v4.3.2.6.md`
- 내부 정적 검수: `VALIDATION_REPORT_v4.3.2.6.md`
...
계정 삭제 함수의 OPTIONS 504/546 문제 해결 절차는 `DEPLOY_DELETE_ACCOUNT_v4.3.2.6.md`를 확인하세요.
